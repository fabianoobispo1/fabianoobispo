...
export default function FileDropzone(props: Props) {
  ...
  if (!file)
    return (
      <label
        htmlFor={name}
        className="border-primary mx-auto flex w-full max-w-lg cursor-pointer flex-col items-center rounded-xl border-2 border-dashed bg-white p-6 text-center"
      >
        <svg
        ...
        <p className="mt-2 tracking-wide text-gray-500">{description}</p>
  ...
  return (
    <>
    <div
      className="border-error mx-auto flex w-full max-w-lg cursor-pointer flex-col items-center rounded-xl border-2 border-dashed bg-white p-6 text-center"
      onClick={(e) => {
    ...
    >
      ...
      <p className="mt-2 tracking-wide text-gray-500">{file.name}</p>
    </div>
