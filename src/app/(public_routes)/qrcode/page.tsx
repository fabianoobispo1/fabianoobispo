...
const QrCodeScanner = dynamic(() => import('./qrcode-scanner'), {
  ssr: false,
  loading: () => (
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-start pt-16 px-4 pb-8">
      ...
      <div className="flex flex-col items-center gap-2 mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Leitor de QR Code</h1>
        <p className="text-muted-foreground text-sm text-center">
          Aponte a câmera para um QR Code para ler o conteúdo
        </p>
      </div>
