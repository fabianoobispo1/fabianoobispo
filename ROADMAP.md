...
- [x] **Arquivar docs de módulos removidos** — `pagamentos.md` e `RESUMO_WHATSAPP_TOOLS.md` descrevem código que não existe mais no repo; movidos para `docs/archived/`.
...
- [x] **Limpar `npm-install.log` da raiz** — artefato de instalação removido.
